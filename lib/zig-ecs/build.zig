...
const Linkage = LibExeObjStep.Linkage;
...
//     }
//
//     artifact.addModule("ecs", getModule(prefix_path));
// }
...
pub fn link(b: *Builder, exe: *LibExeObjStep, linkage: Linkage) void {
...
pub fn getModule(b: *Builder) *Module {
